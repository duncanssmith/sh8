    ...
    <div class="py-4 px2">
        <table class="border category" data-categoryid="{{ $category->id}}">
            ...
            <tr class="text-gray-500">
                ...
                <th class="px-4 py-4 border border-solid"><i class="fa fa-sort" title="Drag and drop rows to sort"></i></th>
...
{{--                <th class="border border-solid">Slug</th>--}}
            ...
            @foreach($texts as $key => $text)
                <tr class="ui-state-default ui-sortable-handle text-gray-500" data-id="{{ $text->id }}">

                    <td class="px-4 py-4 "><i class="fa fa-random text-green-500" title="sort"></i></td>
